...
import com.example.instagramapp.main.CommonDivider
import com.example.instagramapp.main.CommonImage
import com.example.instagramapp.main.CommonProgressSpinner
...
fun ProfileScreen(navController: NavController, vm: IgViewModel) {
    ...
    if (isLoading) {
        ...
        ProfileContent(
            ...
            onBack = { navigateTo(navController = navController, DestinationScreen.MyPostsScreen) },
            onLogout = {
                vm.onLogout()
